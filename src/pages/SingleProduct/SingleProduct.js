        ...
        <div className="py-20 pt-40 px-6 min-h-screen container md:px-24">
            ...
            <div className='flex flex-col md:flex-row justify-center mb-20 w-auto'>
                ...
                <div className='flex flex-col relative'>
                    {product[0].attributes.gia_sanpham && <div className='absolute top-4 right-4 text-secondary-600 py-2 px-4 bg-gray-100 shadow-md text-2xl font-bold rounded-full tracking-wide z-10'>{product[0].attributes.gia_sanpham}</div>}
